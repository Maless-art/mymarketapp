...
const DATA = {
  "Proteínas": ["Muslo encuentro", "Muslo", "Pechuga", "Alitas", "Carne", "Costilla de res", "Ropa vieja", "Puerco", "Costilla de puerco", "Pescado", "Salmón", "Camarones", "Huevos"],
  "Verduras": ["Tomate", "Cebolla", "Ajo", "Lechuga", "Zanahoria", "Pepino", "Habichuelas", "Ají", "Gengibre", "Ñame", "Yuca", "Papas"],
  "Frutas": ["Manzana", "Guineo", "Naranja", "Papaya", "Uvas", "Piña", "Kiwi", "Ciruelas", "Fruta mixta", "Plátano verde"],
  "Lácteos": ["Leche", "Crema de leche", "Leche amanecer", "Yogurt", "Queso Amarillo", "Queso Blanco", "Mantequilla"],
  "Embutidos": ["Jamón", "Salchichas", "Chorizos", "Mortadela"],
  "Enlatados": ["Tuna", "Sardina", "Campbels", "Vegetales mxt", "Jamonilla", "Hongos"],
  "Secos": ["Arroz", "Pan", "Pan cake", "Pasta", "Frijoles", "Lentejas", "Porotos", "Habas", "Arbejas", "Sal", "Harina", "Azúcar", "Café"],
  "Condimentos": ["Aceite", "Vinagre", "Salsa de Tomate", "Pimienta", "Especias", "Curry", "Caldo Rika", "Laurel", "Ajo Molido", "Sazonador", "Consomé de pollo", "Consomé de costilla", "Sopa de costilla", "Ketchup", "Mostaza", "Mayo. compuesta"],
  "Snacks": ["Papas fritas", "Chocolates", "Galletas", "Cheetos", "Sirope"],
